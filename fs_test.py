...
swapper = insightface.model_zoo.get_model(
    r'inswapper_128.onnx', download=False, download_zip=False)
...
def faceswap(face_img):
    ...
    for source_img in img_arr:
        ...
        cv2.imwrite(f'static/images/{fn}', result)
...
if __name__ == '__main__':
    faceswap(r'static\images\KakaoTalk_20231101_180648593.jpg')
